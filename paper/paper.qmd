...
@sec-model-details] provides model detail, and [Appendix-@sec-survey] provides an detailed introduction of surveys, sampling and
observational data in our paper.
...
To address these gaps, in this appendix we propose incorporating surveys to gather
qualitative data, which provide rich, detailed accounts of individual
experiences and contextual factors. Qualitative methods allow for a
deeper understanding of how restrictive abortion policies affect
